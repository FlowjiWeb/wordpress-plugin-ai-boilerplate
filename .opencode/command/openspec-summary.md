---
agent: build
description: Update implementation summary after completing a task section.
---
The user has requested to update the implementation summary for a change proposal. Find the change proposal and follow the instructions below.
<UserRequest>
  $ARGUMENTS
</UserRequest>
<!-- OPENSPEC:START -->
